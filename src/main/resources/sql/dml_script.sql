...
-- ALTER TABLE research ADD CHECK (duration >= '3 mons' AND duration <= '12 mons');
...
INSERT INTO
	research (title, ogrn, from_date, duration, budget, lead_no)
VALUES
	('Выведение позднезимнего сорта яблока','1027739642281', '2022-04-03', '3 mons 20 days', 5510, '1750693')
	, ('Выведение летнего сорта груши','1935729642891', '2021-12-23', '3 mons 10 days', 3501, '1954698')
	, ('Селекция среднерослых культур','1867819241701', '2020-11-11', '11 mons', 7500, '1423696')
	, ('Исследование морозостойкости персиковых культур','1044553943101', '2019-10-12', '10 mons', 8500, '1423696')
	, ('Селекция сеянцев абрикоса','1125139845201', '2018-09-12', '9 mons 4 days', 6220, '1020699')
	, ('Исследование урожайности степных сортов вишни','1028933646301', '2017-08-13', '8 mons 15 days', 9512, '1994694')
	, ('Исследование устойчивости к вредителям садовых культур','1028933646301', '2016-07-17', '7 mons', 5500, '1994694')
	, ('Селекция урожайных сортов персика','1621131446411', '2015-06-18', '6 mons', 5500, '1020699')
	, ('Выведение крупных сортов сливы','1991232648581', '2014-05-19', '5 mons 14 days', 3298, '1954698')
	, ('Выведение сортов смородины позднего срока созревания','1125139845201', '2013-04-20', '4 mons 18 days', 3456, '1750693')
	;
